                    ...
                    if (sonarAvailable == "true") {
                        withCredentials([string(credentialsId: 'sonarqube-token', variable: 'SONAR_TOKEN')]) {
                            ...
                            sh '''
                                ...
                                echo "🧪 Frontend unit tests skipped in analysis stage (already ran in Test Frontend stage)"
                                
                                # Coverage file should have been generated by the Test Frontend stage
                                # Check if it exists from the previous stage
